...
vector<uint32_t> SHA384::convert_uint32_t_from_string(string message, int message_type) {
...
void SHA384::processMessage()
{
	vector<uint64_t> message = this->message;
	vector<uint64_t> hash = this->hash;
	vector<uint64_t> w(80);
	H[0] = 0xcbbb9d5dc1059ed8; H[1] = 0x629a292a367cd507; H[2] = 0x9159015a3070dd17; H[3] = 0x152fecd8f70e5939;
	H[4] = 0x67332667ffc00b31; H[5] = 0x8eb44a8768581511; H[6] = 0xdb0c2e0d64f98fa7; H[7] = 0x47b5481dbefa4fa4;
	size_t i = 0;
...
void SHA384::processMessageChunk(vector<uint64_t>& in)
{
	vector<uint64_t> w(80);
	// Extend the message
...
vector<uint32_t> SHA384::getHashMessageByuint32(vector<uint32_t> message, size_t message_size) {
	...
	this->fillMessage();
	this->processMessage();
	this->hash = vector<uint64_t>(H, H + 6);
	//this->extendMessage();
...
string SHA384::getHashMessage(string message, int message_type, int output_type) {

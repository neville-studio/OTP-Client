...
vector<uint32_t> SHA512_224::convert_uint32_t_from_string(string message, int message_type) {
...
void SHA512_224::processMessage()
{
	vector<uint64_t> message = this->message;
	vector<uint64_t> hash = this->hash;
	vector<uint64_t> w(80);
	H[0] = 0x8C3D37C819544DA2; H[1] = 0x73E1996689DCD4D6; H[2] = 0x1DFAB7AE32FF9C82; H[3] = 0x679DD514582F9FCF;
	H[4] = 0x0F6D2B697BD44DA8; H[5] = 0x77E36F7304C48942; H[6] = 0x3F9D85A86A1D36C8; H[7] = 0x1112E6AD91D692A1;
...
void SHA512_224::processMessageChunk(vector<uint64_t>& in)
{
	vector<uint64_t> w(80);
	// Extend the message
...
vector<uint32_t> SHA512_224::getHashMessageByuint32(vector<uint32_t> message, size_t message_size) {
	...
	return vector<uint32_t>(result.begin(), result.begin() + 7);
}


string SHA512_224::getHashMessage(string message, int message_type, int output_type) {
